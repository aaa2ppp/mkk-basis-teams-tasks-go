// Code generated by "enumer -type Role -linecomment -json -sql"; DO NOT EDIT.
...
const _RoleName = "owneradminmember"

var _RoleIndex = [...]uint8{0, 5, 10, 16}

const _RoleLowerName = "owneradminmember"
...
var _RoleValues = []Role{RoleOwner, RoleAdmin, RoleMember}

var _RoleNameToValueMap = map[string]Role{
	_RoleName[0:5]:        RoleOwner,
	_RoleLowerName[0:5]:   RoleOwner,
	_RoleName[5:10]:       RoleAdmin,
	_RoleLowerName[5:10]:  RoleAdmin,
	_RoleName[10:16]:      RoleMember,
	_RoleLowerName[10:16]: RoleMember,
}
